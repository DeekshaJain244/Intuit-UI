...
import type { sts_internal_api_nimble_licenseResp } from './sts_internal_api_nimble_licenseResp';
import type { sts_internal_api_nimble_nimbleRetryConfig } from './sts_internal_api_nimble_nimbleRetryConfig';

export type sts_internal_api_nimble_nimbleResp = {
    license?: sts_internal_api_nimble_licenseResp;
