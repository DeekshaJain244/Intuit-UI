...
import type { sts_internal_api_rule_action } from './sts_internal_api_rule_action';
import type { sts_internal_api_rule_notification } from './sts_internal_api_rule_notification';

export type sts_internal_api_rule_ruleResp = {
    is_active?: boolean;
    rule_action?: Array<sts_internal_api_rule_action>;
    rule_expand?: any;
