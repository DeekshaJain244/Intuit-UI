      ...
      class i {
        ...
        pointermove_handler(e) {
          ...
          if (2 == this.evCache.length) {
            ...
            this.prevDiff > 100 && (n > this.prevDiff && this.zoom_in(), n < this.prevDiff && this.zoom_out()),
              (this.prevDiff = n);
          }
        }
        pointerup_handler(e) {
        ...
        click(e) {
          if ((this.dispatch("click", e), "fixed" === this.editor_mode)) {
            ...
            "view" === this.editor_mode
              ? (null != e.target.closest(".drawflow") || e.target.matches(".parent-drawflow")) &&
        ...
        position(e) {
          ...
          if (
            ...
            (this.pos_x = t),
              ...
              (this.drawflow.drawflow[this.module].data[this.ele_selected.id.slice(5)].pos_x =
                this.ele_selected.offsetLeft - i),
              (this.drawflow.drawflow[this.module].data[this.ele_selected.id.slice(5)].pos_y =
                this.ele_selected.offsetTop - s),
              this.updateConnectionNodes(this.ele_selected.id);
          }
          if (this.drag_point) {
            (i = ((this.pos_x - t) * this.precanvas.clientWidth) / (this.precanvas.clientWidth * this.zoom)),
              (s = ((this.pos_y - n) * this.precanvas.clientHeight) / (this.precanvas.clientHeight * this.zoom));
            (this.pos_x = t), (this.pos_y = n);
            var o =
                this.pos_x * (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)) -
                this.precanvas.getBoundingClientRect().x *
                  (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)),
              l =
                this.pos_y * (this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom)) -
          ...
          if (
            ...
            if (
              ...
              (this.force_first_input &&
                (null != i.closest(".drawflow_content_node") || "drawflow-node" === i.classList[0]))
            ) {
              if (
                !this.force_first_input ||
                (null == i.closest(".drawflow_content_node") && "drawflow-node" !== i.classList[0])
              ...
              if (l !== s && !1 !== o) {
                if (
                  0 ===
                  this.container.querySelectorAll(".connection.node_in_" + s + ".node_out_" + l + "." + c + "." + o)
                    .length
                ) {
        ...
        contextmenu(e) {
          if (
            ...
            e.preventDefault(),
            "fixed" === this.editor_mode || "view" === this.editor_mode)
          )
            return !1;
          if (
        ...
        zoom_refresh() {
          this.dispatch("zoom", this.zoom),
            ...
            (this.precanvas.style.transform =
              "translate(" + this.canvas_x + "px, " + this.canvas_y + "px) scale(" + this.zoom + ")");
        }
        zoom_in() {
        ...
        updateConnection(e, t) {
          ...
          var l = this.connection_ele.children[0],
            c =
              ...
              (this.ele_selected.getBoundingClientRect().x - n.getBoundingClientRect().x) * s,
            d =
              this.ele_selected.offsetHeight / 2 +
              (this.ele_selected.getBoundingClientRect().y - n.getBoundingClientRect().y) * o,
            a =
              e * (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)) -
              this.precanvas.getBoundingClientRect().x *
                (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)),
            r =
              t * (this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom)) -
              this.precanvas.getBoundingClientRect().y *
                (this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom)),
            h = this.curvature,
              ...
              n.forEach((t, a) => {
                if (0 === a && n.length - 1 == 0) {
                  var f = i.querySelector("#" + e),
                    ...
                    w =
                      (L = f.querySelectorAll("." + t.parentElement.classList[3])[0]).offsetWidth / 2 +
                      (L.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
                  ...
                  (m =
                    (R = E.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 +
                    (R.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                  ...
                  (f = t),
                    ...
                    (_ = R.offsetHeight / 2 + (R.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                    (w =
                      (f.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                        (s.clientWidth / (s.clientWidth * h)) +
                      r),
                    (v =
                      (f.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                        (s.clientHeight / (s.clientHeight * h)) +
                      r),
                    (y = l(w, v, m, _, d, "close"));
                  (o += y), g.push(y);
                } else {
                  (f = t),
                    (m =
                      ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) *
                        (s.clientWidth / (s.clientWidth * h)) +
                      r),
                    (_ =
                      (x.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                        (s.clientHeight / (s.clientHeight * h)) +
                      r),
                    (w =
                      (f.getBoundingClientRect().x - s.getBoundingClientRect().x) *
          ...
          Object.keys(g).map(function (t, n) {
            if (null === g[t].querySelector(".point")) {
              var h = i.querySelector("#" + e),
                ...
                v =
                  (h = h.querySelectorAll("." + g[t].classList[4])[0]).offsetWidth / 2 +
                  (h.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
              ...
              n.forEach((t, a) => {
                if (0 === a && n.length - 1 == 0) {
                  var f = i.querySelector("#" + e),
                    ...
                    _ =
                      (E = f.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 +
                      (E.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
                  ...
                  (g =
                    (x = L.querySelectorAll("." + t.parentElement.classList[3])[0]).offsetWidth / 2 +
                    (x.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                  ...
                  (f = t),
                    ...
                    (_ =
                      (E = L.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 +
                      (E.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                    (w = E.offsetHeight / 2 + (E.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                    (g = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                    (m = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
        ...
        createReroutePoint(e) {
          ...
          void 0 === this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points &&
            (this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points = []),
            this.reroute_fix_curvature
              ? (d > 0
                  ? this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points.splice(d, 0, {
                      pos_x: l,
                      pos_y: c,
                    })
        ...
        addNode(e, t, n, i, s, o, l, c, d = !1) {
          ...
          for (var g = 0; g < t; g++) {
            ...
            e.classList.add("input"),
              e.classList.add("input_" + (g + 1)),
              (f["input_" + (g + 1)] = { connections: [] }),
              u.appendChild(e);
          }
          const m = {};
          for (g = 0; g < n; g++) {
            ...
            e.classList.add("output"),
              e.classList.add("output_" + (g + 1)),
              (m["output_" + (g + 1)] = { connections: [] }),
              p.appendChild(e);
          }
          ...
          if ((_.classList.add("drawflow_content_node"), !1 === d)) _.innerHTML = c;
            ...
            let e = new this.render({
              parent: this.parent,
              render: (e) => e(this.noderegister[c].html, { props: this.noderegister[c].props }),
                ...
                null !== t &&
                  Object.entries(t).forEach(function (n, s) {
                    if ("object" == typeof n[1]) e(t, n[0], i + "-" + n[0]);
                      ...
                      for (var o = _.querySelectorAll("[df-" + i + "-" + n[0] + "]"), l = 0; l < o.length; l++)
                        (o[l].value = n[1]), o[l].isContentEditable && (o[l].innerText = n[1]);
                  });
              })(null, e[0], e[0]);
            else
              for (var n = _.querySelectorAll("[df-" + e[0] + "]"), i = 0; i < n.length; i++)
                (n[i].value = e[1]), n[i].isContentEditable && (n[i].innerText = e[1]);
          }),
            h.appendChild(u),
            h.appendChild(_),
            h.appendChild(p),
        ...
        addNodeImport(e, t) {
          ...
          (i.innerHTML = ""),
            ...
            "" != e.class && i.classList.add(...e.class.split(" "));
          ...
          if ((c.classList.add("drawflow_content_node"), !1 === e.typenode)) c.innerHTML = e.html;
            ...
            let t = new this.render({
              parent: this.parent,
              render: (t) => t(this.noderegister[e.html].html, { props: this.noderegister[e.html].props }),
              ...this.noderegister[e.html].options,
            }).$mount();
            c.appendChild(t.$el);
          }
                ...
                null !== n &&
                  Object.entries(n).forEach(function (e, i) {
                    if ("object" == typeof e[1]) t(n, e[0], s + "-" + e[0]);
                      ...
                      for (var o = c.querySelectorAll("[df-" + s + "-" + e[0] + "]"), l = 0; l < o.length; l++)
                        (o[l].value = e[1]), o[l].isContentEditable && (o[l].innerText = e[1]);
                  });
              })(null, t[0], t[0]);
            else
              for (var i = c.querySelectorAll("[df-" + t[0] + "]"), s = 0; s < i.length; s++)
                (i[s].value = t[1]), i[s].isContentEditable && (i[s].innerText = t[1]);
          }),
            i.appendChild(s),
            i.appendChild(c),
            i.appendChild(o),
            ...
            Object.keys(e.outputs[s].connections).map(function (o, l) {
              ...
              void 0 !== c &&
                c.forEach((l, d) => {
                  ...
                  var g = l.pos_x,
                    m = l.pos_y;
                  f.setAttributeNS(null, "cx", g),
                    f.setAttributeNS(null, "cy", m),
        ...
        updateNodeValue(e) {
          for (var t = e.target.attributes, n = 0; n < t.length; n++)
            if (t[n].nodeName.startsWith("df-")) {
              for (
                var i = t[n].nodeName.slice(3).split("-"),
                  s =
                    this.drawflow.drawflow[this.module].data[
                      e.target.closest(".drawflow_content_node").parentElement.id.slice(5)
                    ].data,
                  o = 0;
                o < i.length - 1;
                o += 1
                  ...
                  null !== i &&
                    Object.entries(i).forEach(function (t, s) {
                      if ("object" == typeof t[1]) e(i, t[0], o + "-" + t[0]);
                        ...
                        for (var l = n.querySelectorAll("[df-" + o + "-" + t[0] + "]"), c = 0; c < l.length; c++)
                          (l[c].value = t[1]), l[c].isContentEditable && (l[c].innerText = t[1]);
                    });
                })(null, e[0], e[0]);
              else
                for (var s = n.querySelectorAll("[df-" + e[0] + "]"), o = 0; o < s.length; o++)
                  (s[o].value = e[1]), s[o].isContentEditable && (s[o].innerText = e[1]);
            });
          }
        }
        addNodeInput(e) {
                ...
                if (parseInt(c) < parseInt(o)) {
                  if (this.module === n) {
                    const n = this.container.querySelector(
                      ".connection.node_in_node-" + e + ".node_out_node-" + t.node + "." + t.input + ".input_" + o
                    );
            ...
            this.drawflow.drawflow[n].data[t.node].inputs[t.output].connections.forEach((i, s) => {
              if (i.node == e) {
                ...
                if (parseInt(c) < parseInt(o)) {
                  if (this.module === n) {
                    const n = this.container.querySelector(
                      ".connection.node_in_node-" + t.node + ".node_out_node-" + e + ".output_" + o + "." + t.output
                    );
        ...
        removeNodeId(e) {
          ...
          this.module === t && this.container.querySelector("#" + e).remove(),
        ...
        removeConnection() {
          if (null != this.connection_selected) {
            ...
            var t = this.drawflow.drawflow[this.module].data[e[2].slice(14)].outputs[e[3]].connections.findIndex(
              function (t, n) {
            ...
            var n = this.drawflow.drawflow[this.module].data[e[1].slice(13)].inputs[e[4]].connections.findIndex(
              function (t, n) {
        ...
        removeSingleConnection(e, t, n, i) {
          ...
          if (s === this.getModuleFromNodeId(t)) {
            if (
              ...
              this.module === s &&
                this.container
                  .querySelector(".connection.node_in_node-" + t + ".node_out_node-" + e + "." + n + "." + i)
                  .remove();
              ...
              return (
                this.drawflow.drawflow[s].data[t].inputs[i].connections.splice(l, 1),
                this.dispatch("connectionRemoved", { output_id: e, input_id: t, output_class: n, input_class: i }),
                !0
              );
            }
            return !1;
        ...
        removeConnectionNodeId(e) {
          ...
          for (var s = i.length - 1; s >= 0; s--) {
            var o = i[s].classList,
              l = this.drawflow.drawflow[this.module].data[o[1].slice(13)].inputs[o[4]].connections.findIndex(function (
                e,
                t
              ) {
            ...
            var c = this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.findIndex(
              function (e, t) {
          ...
          for (s = d.length - 1; s >= 0; s--) {
            (o = d[s].classList),
              (c = this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.findIndex(
                function (e, t) {
                  return e.node === o[1].slice(13) && e.output === o[4];
                }
              ));
